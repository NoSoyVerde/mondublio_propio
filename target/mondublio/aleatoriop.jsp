        ...
        <div class="col-md-7 col-lg-6">
          <div class="card shadow-lg border-0 rounded-4">
            <div class="card-body text-center p-5">
              ...
              <% boolean error = false; String supParam =
              request.getParameter("sup"); String infParam =
              request.getParameter("inf"); if (supParam == null || infParam ==
              null || supParam.isEmpty() || infParam.isEmpty()) { out.print("
              <div class="alert alert-warning rounded-3 shadow-sm">
                Por favor, introduce ambos límites.
              </div>
              "); error = true; } else { try { int max =
              Integer.parseInt(supParam); int min = Integer.parseInt(infParam);
              if (max < min) { out.print("
              <div class="alert alert-danger rounded-3 shadow-sm">
                El límite superior debe ser mayor o igual que el límite
                inferior.
              </div>
              "); error = true; } else { Random rand = new Random(); int
              randomNum = rand.nextInt((max - min) + 1) + min; out.print("
              ...
              "); error = true; } } if (error) { out.print("<meta
                http-equiv="refresh"
                content="5;url=formulario.html"
              />"); } %>
